...
const Become = () => {
    ...
    const getAuthorsDemande = async () => {

        console.log("ok server 2");

        var response = await Api.getData('getUserDemande');
    ...
    const definirCommeAuteur = async (data: any) => {
        seterrorMsg("");

        console.log("ok server 2");

        var response = await Api.postData('confirmTobeAuthor/'+data);
        console.log("ok server 215487659878");
        ...
        if (response.status == 200) {
                ...
                if (!response.data.success) {
                    seterrorMsg("Impossible de devinir comme auteur");

                    return null;
                }
                getAuthorsDemande();
                seterrorMsg("utilisateur actuelement auteur");
                getAuthorsDemande();
                                    ...
                                    <table className="table table-striped table tablesorter" id="ipi-table">
                                        <thead className="thead-dark">
                                            <tr>
                                                ...
                                                <th className="text-center">Télephone</th>
                                                <th>Solde</th>
                ...
                <div className="modal-dialog" role="document">
                    <div className="modal-content">
                        <div className="modal-header">
                            <h4 className="modal-title">Devenir un Auteur</h4><button type="button" className="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                                                ...
                                                <div className="card-body">
                                                    <div className="d-flex flex-column align-items-center text-center">
                                                        ...
                                                        <div className="mt-3">
                                                            ...
                                                            <h4>{CurentAuthorData.toBeAuthor === 1 ? "Demande encour" : ""}</h4>
                                                            <a className='btn btn-primary m-2 p-2' onClick={() => definirCommeAuteur(CurentAuthorData.id)}>Valider</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>

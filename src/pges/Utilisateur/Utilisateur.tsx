                                    ...
                                    <table className="table table-striped table tablesorter" id="ipi-table">
                                        <thead className="thead-dark">
                                            <tr>
                                                ...
                                                <th className="text-center">est un Auteur ?</th>
                                                <th className="text-center">Date d'expiration</th>
                                        ...
                                        <tbody className="text-center">
                                            {authors.map((item: any) => (
                                                <tr>
                                                    <td>{item.name}</td>
                                                    <td>{item.toBeAuthor === 2 ? "Auteur" : item.toBeAuthor === 1 ? "Demande Encour" : "Utilisateur"}</td>
                                                    <td>{item.name}</td>
                                                ...
                                                <div className="card-body">
                                                    <div className="d-flex flex-column align-items-center text-center">
                                                        ...
                                                        <div className="mt-3">
                                                            ...
                                                            <h4 className='bg-success text-white p-1 mt-10'>{CurentAuthorData.toBeAuthor === 2 ? "Auteur" : CurentAuthorData.toBeAuthor === 1 ? "Demande Encour" : "Utilisateur"}</h4>
                                        ...
                                        <div className="col-md-8">
                                            <div className="card mb-3">
                                                <dl className="row">
                                                    ...
                                                    <dt className="my-2 col-sm-5">Status Abonnement: </dt>
                                                    <dd className="my-2 col-sm-7">{CurentAuthorData.secondName}</dd>
                                                    ...
                                                    {CurentAuthorData.toBeAuthor === 2 ?
                                                        <><dt className="my-1 col-sm-5">Nombre de livre publié</dt><dd className="my-1 col-sm-7">{CurentAuthorData.owne}</dd><dt className="my-2 col-sm-5">Nombre de Livre vendu</dt><dd className="my-2 col-sm-7">{CurentAuthorData.selle}</dd></>
                                                        :
                                                        <></>}

                                                    <dt className="my-1 col-sm-5">Date d'inscription</dt>
                                                    <dd className="my-1 col-sm-7">{CurentAuthorData.created_at}</dd>
                                                    <dt className="my-1 col-sm-5">Expiration</dt>
                                                    <dd className="my-1 col-sm-7">{CurentAuthorData.name}</dd>
                                                </dl>
                                            </div>
